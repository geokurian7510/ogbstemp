...
<!-- End Contact Page Nav -->
  ...
  <!-- Modal -->
  <?php
  $sqlstock = "SELECT * FROM cylinder";
  $rlt =  mysqli_query($conn, $sqlstock);
  $rows = mysqli_fetch_array($rlt);
  ?>
<div class="modal fade" id="feedbackModal" tabindex="-1" aria-labelledby="feedbackModalLabel" aria-hidden="true">
    ...
    <input type="text"  name="quantity" id="stockPrice" placeholder="" value="<?php echo $rows['quantity']; ?>"><br>
    <label for="stock"><b>Connection Price</b> </label>
    <input type="text" name="conn_amount" id="stockPrice" placeholder="" value="<?php echo $rows['conn_amount']; ?>" >
  <br>  <label for="stock"><b>Cylinder Price </b></label>
    <input type="text" name="c_price" id="stockPrice" placeholder="" value="<?php echo $rows['c_price']; ?>" >
