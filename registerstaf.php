...
if($pwd==$confirmpassword)
    ...
    $sql="insert into staff (f_name,l_name,phn_number,email,pwd,typeofuser)values('$f_name','$l_name','$phn_number','$email','$pwd','$user')";
			...
			<div class="inner">
				...
				<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
					...
					<div class="form-group">
						...
						<input type="text" placeholder="Last Name" name="l_name" class="form-control" value="<?php echo $l_name;?>">
					...
					<div class="form-wrapper">
						...
						<input type="submit" class="btn btn-success" value="REGISTER" name="submit" i class="zmdi zmdi-arrow-right">
