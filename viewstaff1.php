        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td>
                   <?php
                   if ($row['status'] == 1) {
                       echo '  <span class="badge bg-success text-dark"><i class="bi bi-check-circle me-1"></i> Approved</span>
                       ';
                   } elseif ($row['status'] == 2) {
                       echo '<span class="badge bg-primary text-dark"><i class="bi bi-star me-1"></i> On leave</span>';
                   } else {
                       echo '<span class="badge bg-warning text-dark"><i class="bi bi-exclamation-triangle me-1"></i> Pending</span>';
                   }
                   ?>
                </td>
                <td>
