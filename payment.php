...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO payment (cardno, year,month, cvv, name) VALUES ('$cardno','$year', '$month', '$cvv', '$name')";

    // Execute the SQL query
    $result = mysqli_query($conn, $sql);

    if ($result) {
        // Payment information successfully inserted
        // Redirect to a thank you page or perform any other necessary actions
        ?>
               <script>
                   Swal.fire({
                       icon: 'success',
      ...
      <form action="" method="post">
        <div class="card-form__inner">
          <div class="card-input">
            ...
            <input type="text" id="cardNumber" name="cardno" class="card-input__input" name="cardno" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardno" autocomplete="off" required />
          </div>
          
          <div class="card-input">
            <label for="cardName" class="card-input__label">Card Holders</label>
            <input type="text" id="cardName" class="card-input__input"  name="name"v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off" required />
          </div>
          <div class="card-form__row">
            ...
            <div class="card-form__col -cvv">
              <div class="card-input">
                ...
                <input type="text" class="card-input__input" id="cardCvv" name="cvv" v-mask="'####'" maxlength="3" v-model="cardCvv" v-on:focus="flipCard(true)" v-on:blur="flipCard(false)" autocomplete="off" required />
              </div>
            </div>
          </div>
          <?php $grandtotal=$_SESSION['totalbill']; ?>
          <button class="card-form__button" type="submit" name="payNow">&#8377;<?php echo $grandtotal;?>
